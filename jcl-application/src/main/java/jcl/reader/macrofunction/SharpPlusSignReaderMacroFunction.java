...
public class SharpPlusSignReaderMacroFunction extends ReaderMacroFunction {
	...
	@PostConstruct
	private void init() {
		ReaderVariables.READTABLE.getVariableValue().setDispatchMacroCharacter(CharacterConstants.NUMBER_SIGN, CharacterConstants.PLUS_SIGN, this);
	}
	...
	public boolean equals(final Object obj) {
		...
		final SharpPlusSignReaderMacroFunction rhs = (SharpPlusSignReaderMacroFunction) obj;
