...
(defun unuse-package (packages &optional (package *package*))
  ...
  (let* ((package (find-package package))
         (packages (package-listify symbols)))
    ($unuse-package package packages)))
...
;;;
;;;    Take the list of names nd ensures that the list is a list of Strings by checking that each namd is a String
...
(defun rename-package (package new-name &optional new-nicknames)
  ...
  (let* ((package (find-package package))
    ...
    ($rename-package package name new-nicknames)))
...
(export '(list-all-packages package-name package-nicknames package-shadowing-symbols package-use-list package-used-by-list
          delete-package find-symbol intern unintern find-all-symbols use-package unuse-package export import
          shadowing-import unexport rename-package shadow)
        "COMMON-LISP")