...
@Component
public final class InputStreamPFunction extends CommonLispBuiltInFunctionStructBase {

	private static final String FUNCTION_NAME = "INPUT-STREAM-P";
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return LispStructFactory.toBoolean(stream.isInputStream());
	}
}
