...
@Component
public final class CharFunction extends CommonLispBuiltInFunctionStructBase {

	private static final String FUNCTION_NAME = "CHAR";
	private static final String STRING_ARGUMENT = "STRING";
	private static final String INDEX_ARGUMENT = "INDEX";

	public CharFunction() {
		super("Char accesses the element of string specified by index.",
		      FUNCTION_NAME,
