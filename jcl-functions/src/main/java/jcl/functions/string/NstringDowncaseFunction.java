...
@Component
public final class NstringDowncaseFunction extends CommonLispBuiltInFunctionStructBase {

	private static final String FUNCTION_NAME = "NSTRING-DOWNCASE";
	private static final String STRING_ARGUMENT = "STRING";

	public NstringDowncaseFunction() {
		super("Returns the provided string modified with all uppercase characters replaced by the corresponding lowercase characters.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return struct.nStringDowncase(builder.build());
	}
}
