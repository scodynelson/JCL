...
@Component
public final class NstringUpcaseFunction extends CommonLispBuiltInFunctionStructBase {

	private static final String FUNCTION_NAME = "NSTRING-UPCASE";
	private static final String STRING_ARGUMENT = "STRING";

	public NstringUpcaseFunction() {
		super("Returns the provided string modified with all lowercase characters replaced by the corresponding uppercase characters.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return struct.nStringUpcase(builder.build());
	}
}
