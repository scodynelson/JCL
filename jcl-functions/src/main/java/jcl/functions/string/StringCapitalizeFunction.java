...
@Component
public final class StringCapitalizeFunction extends CommonLispBuiltInFunctionStructBase {

	private static final String FUNCTION_NAME = "STRING-CAPITALIZE";
	private static final String STRING_ARGUMENT = "STRING";

	public StringCapitalizeFunction() {
		super("Produces a copy of string such that, for every word in the copy, the first character of the ``word,'' if it has case, is uppercase and any other characters with case in the word are lowercase.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return struct.stringCapitalize(builder.build());
	}
}
