...
@Component
public final class StringEqFunction extends CommonLispBuiltInFunctionStructBase {
	...
	public StringEqFunction() {
		super("String= is true if the supplied substrings are of the same length and contain the same characters in corresponding positions; otherwise it is false.",
		      FUNCTION_NAME,
