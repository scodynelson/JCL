...
@Component
public final class StringEqualFunction extends CommonLispBuiltInFunctionStructBase {

	private static final String FUNCTION_NAME = "STRING-EQUAL";
	...
	public StringEqualFunction() {
		super("String-equal is just like string= except that differences in case are ignored; two characters are considered to be the same if char-equal is true of them.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		final boolean stringEqualIgnoreCase = struct1.stringEqualIgnoreCase(builder.build());
		return BooleanStruct.toLispBoolean(stringEqualIgnoreCase);
	}
}
