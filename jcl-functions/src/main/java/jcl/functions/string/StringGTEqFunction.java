...
@Component
public final class StringGTEqFunction extends CommonLispBuiltInFunctionStructBase {
	...
	public StringGTEqFunction() {
		super("String>= is true if substring1 is greater than or equal to substring2; otherwise it is false.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return struct1.stringGreaterThanOrEqualTo(builder.build());
	}
}
