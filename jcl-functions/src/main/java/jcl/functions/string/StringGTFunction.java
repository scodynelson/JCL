...
@Component
public final class StringGTFunction extends CommonLispBuiltInFunctionStructBase {
	...
	public StringGTFunction() {
		super("String> is true if substring1 is greater than substring2; otherwise it is false.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return struct1.stringGreaterThan(builder.build());
	}
}
