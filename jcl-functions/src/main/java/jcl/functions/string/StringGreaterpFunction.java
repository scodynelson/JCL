...
@Component
public final class StringGreaterpFunction extends CommonLispBuiltInFunctionStructBase {

	private static final String FUNCTION_NAME = "STRING-GREATERP";
	...
	public StringGreaterpFunction() {
		super("String-greaterp are exactly like string>, except that distinctions between uppercase and lowercase letters are ignored. It is as if char-greaterp were used instead of char> for comparing characters.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return struct1.stringGreaterThanIgnoreCase(builder.build());
	}
}
