...
@Component
public final class StringLTEqFunction extends CommonLispBuiltInFunctionStructBase {
	...
	public StringLTEqFunction() {
		super("String<= is true if substring1 is less than or equal to substring2; otherwise it is false.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return struct1.stringLessThanOrEqualTo(builder.build());
	}
}
