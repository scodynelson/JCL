...
@Component
public final class StringLeftTrimFunction extends CommonLispBuiltInFunctionStructBase {

	private static final String FUNCTION_NAME = "STRING-LEFT-TRIM";
	private static final String CHARACTER_BAG_ARGUMENT = "CHARACTER-BAG";
	private static final String STRING_ARGUMENT = "STRING";

	public StringLeftTrimFunction() {
		super("Returns a substring of string, with all characters in character-bag stripped off the beginning.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return struct.stringLeftTrim(characterBag);
	}
}
