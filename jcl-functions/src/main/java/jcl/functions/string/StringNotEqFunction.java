...
@Component
public final class StringNotEqFunction extends CommonLispBuiltInFunctionStructBase {
	...
	public StringNotEqFunction() {
		super("String/= is true if the supplied substrings are different; otherwise it is false.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return struct1.stringNotEqual(builder.build());
	}
}
