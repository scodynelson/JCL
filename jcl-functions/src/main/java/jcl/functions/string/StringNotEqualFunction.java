...
@Component
public final class StringNotEqualFunction extends CommonLispBuiltInFunctionStructBase {

	private static final String FUNCTION_NAME = "STRING-NOT-EQUAL";
	...
	public StringNotEqualFunction() {
		super("String-not-equal is just like string/= except that differences in case are ignored; two characters are considered to be the same if char-not-equal is true of them.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return struct1.stringNotEqualIgnoreCase(builder.build());
	}
}
