...
@Component
public final class StringNotGreaterpFunction extends CommonLispBuiltInFunctionStructBase {

	private static final String FUNCTION_NAME = "STRING-NOT-GREATERP";
	...
	public StringNotGreaterpFunction() {
		super("String-not-greaterp is exactly like string<=, except that distinctions between uppercase and lowercase letters are ignored. It is as if char-lessp were used instead of char< for comparing characters.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return struct1.stringLessThanOrEqualToIgnoreCase(builder.build());
	}
}
