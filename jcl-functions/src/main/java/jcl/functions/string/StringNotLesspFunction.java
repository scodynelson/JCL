...
@Component
public final class StringNotLesspFunction extends CommonLispBuiltInFunctionStructBase {

	private static final String FUNCTION_NAME = "STRING-NOT-LESSP";
	...
	public StringNotLesspFunction() {
		super("String-not-lessp is exactly like string>=, except that distinctions between uppercase and lowercase letters are ignored. It is as if char-greaterp were used instead of char> for comparing characters.",
		      FUNCTION_NAME,
	...
	public LispStruct apply(final Arguments arguments) {
		...
		return struct1.stringGreaterThanOrEqualToIgnoreCase(builder.build());
	}
}
