...
public interface CompilerConstants {
	...
	ConstantStruct<IntegerStruct> CALL_ARGUMENTS_LIMIT = new ConstantStruct<>("CALL-ARGUMENTS-LIMIT", GlobalPackageStruct.COMMON_LISP, IntegerStruct.valueOf(BigInteger.valueOf(Short.MAX_VALUE)));
	...
	ConstantStruct<?> LAMBDA_LIST_KEYWORDS = new ConstantStruct<>("LAMBDA-LIST-KEYWORDS", GlobalPackageStruct.COMMON_LISP,
	                                                              ListStruct.buildProperList(
			                                                              ...
			                                                              REST,
			                                                              WHOLE));
	ConstantStruct<IntegerStruct> LAMBDA_PARAMETERS_LIMIT = new ConstantStruct<>("LAMBDA-PARAMETERS-LIMIT", GlobalPackageStruct.COMMON_LISP, IntegerStruct.valueOf(BigInteger.valueOf(Short.MAX_VALUE)));

	ConstantStruct<IntegerStruct> MULTIPLE_VALUES_LIMIT = new ConstantStruct<>("MULTIPLE-VALUES-LIMIT", GlobalPackageStruct.COMMON_LISP, IntegerStruct.valueOf(BigInteger.valueOf(Short.MAX_VALUE)));

	ConstantStruct<IntegerStruct> INTERNAL_TIME_UNITS_PER_SECOND = new ConstantStruct<>("INTERNAL-TIME-UNITS-PER-SECOND", GlobalPackageStruct.COMMON_LISP, IntegerStruct.valueOf(BigInteger.valueOf(1000000)));
}
