...
public interface CompilerConstants {
	...
	ConstantStruct<IntegerStruct> CALL_ARGUMENTS_LIMIT = ConstantStruct.valueOf("CALL-ARGUMENTS-LIMIT", GlobalPackageStruct.COMMON_LISP, IntegerStructImpl.valueOf(BigInteger.valueOf(Short.MAX_VALUE)));
	...
	ConstantStruct<?> LAMBDA_LIST_KEYWORDS = ConstantStruct.valueOf("LAMBDA-LIST-KEYWORDS", GlobalPackageStruct.COMMON_LISP,
	                                                              LispStructFactory.toProperList(
			                                                              ...
			                                                              REST,
			                                                              WHOLE));
	ConstantStruct<IntegerStruct> LAMBDA_PARAMETERS_LIMIT = ConstantStruct.valueOf("LAMBDA-PARAMETERS-LIMIT", GlobalPackageStruct.COMMON_LISP, IntegerStructImpl.valueOf(BigInteger.valueOf(Short.MAX_VALUE)));

	ConstantStruct<IntegerStruct> MULTIPLE_VALUES_LIMIT = ConstantStruct.valueOf("MULTIPLE-VALUES-LIMIT", GlobalPackageStruct.COMMON_LISP, IntegerStructImpl.valueOf(BigInteger.valueOf(Short.MAX_VALUE)));

	ConstantStruct<IntegerStruct> INTERNAL_TIME_UNITS_PER_SECOND = ConstantStruct.valueOf("INTERNAL-TIME-UNITS-PER-SECOND", GlobalPackageStruct.COMMON_LISP, IntegerStructImpl.valueOf(BigInteger.valueOf(1000000)));
}
