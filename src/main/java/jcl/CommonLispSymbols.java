...
public interface CommonLispSymbols {
	...
	SymbolStruct<?> AND_ALLOW_OTHER_KEYS = Constant.ALLOW_OTHER_KEYS;
	SymbolStruct<?> AND_AUX = Constant.AUX;
	SymbolStruct<?> AND_BODY = Constant.BODY;
	SymbolStruct<?> AND_ENVIRONMENT = Constant.ENVIRONMENT;
	SymbolStruct<?> AND_KEY = Constant.KEY;
	SymbolStruct<?> AND_OPTIONAL = Constant.OPTIONAL;
	SymbolStruct<?> AND_REST = Constant.REST;
	SymbolStruct<?> AND_WHOLE = Constant.WHOLE;

	SymbolStruct<?> ARRAY_DIMENSION_LIMIT = Constant.ARRAY_DIMENSION_LIMIT;
	SymbolStruct<?> ARRAY_RANK_LIMIT = Constant.ARRAY_RANK_LIMIT;
	SymbolStruct<?> ARRAY_TOTAL_SIZE_LIMIT = Constant.ARRAY_TOTAL_SIZE_LIMIT;
	SymbolStruct<?> BOOLE_1 = Constant.BOOLE_1;
	SymbolStruct<?> BOOLE_2 = Constant.BOOLE_2;
	SymbolStruct<?> BOOLE_AND = Constant.BOOLE_AND;
	SymbolStruct<?> BOOLE_ANDC1 = Constant.BOOLE_ANDC1;
	SymbolStruct<?> BOOLE_ANDC2 = Constant.BOOLE_ANDC2;
	SymbolStruct<?> BOOLE_C1 = Constant.BOOLE_C1;
	SymbolStruct<?> BOOLE_C2 = Constant.BOOLE_C2;
	SymbolStruct<?> BOOLE_CLR = Constant.BOOLE_CLR;
	SymbolStruct<?> BOOLE_EQV = Constant.BOOLE_EQV;
	SymbolStruct<?> BOOLE_IOR = Constant.BOOLE_IOR;
	SymbolStruct<?> BOOLE_NAND = Constant.BOOLE_NAND;
	SymbolStruct<?> BOOLE_NOR = Constant.BOOLE_NOR;
	SymbolStruct<?> BOOLE_ORC1 = Constant.BOOLE_ORC1;
	SymbolStruct<?> BOOLE_ORC2 = Constant.BOOLE_ORC2;
	SymbolStruct<?> BOOLE_SET = Constant.BOOLE_SET;
	SymbolStruct<?> BOOLE_XOR = Constant.BOOLE_XOR;
	SymbolStruct<?> CALL_ARGUMENTS_LIMIT = Constant.CALL_ARGUMENTS_LIMIT;
	SymbolStruct<?> CHAR_CODE_LIMIT = Constant.CHAR_CODE_LIMIT;
	SymbolStruct<?> DOUBLE_FLOAT_EPSILON = Constant.DOUBLE_FLOAT_EPSILON;
	SymbolStruct<?> DOUBLE_FLOAT_NEGATIVE_EPSILON = Constant.DOUBLE_FLOAT_NEGATIVE_EPSILON;
	SymbolStruct<?> INTERNAL_TIME_UNITS_PER_SECOND = Constant.INTERNAL_TIME_UNITS_PER_SECOND;
	SymbolStruct<?> LAMBDA_LIST_KEYWORDS = Constant.LAMBDA_LIST_KEYWORDS;
	SymbolStruct<?> LAMBDA_PARAMETERS_LIMIT = Constant.LAMBDA_PARAMETERS_LIMIT;
	SymbolStruct<?> LEAST_NEGATIVE_DOUBLE_FLOAT = Constant.LEAST_NEGATIVE_DOUBLE_FLOAT;
	SymbolStruct<?> LEAST_NEGATIVE_LONG_FLOAT = Constant.LEAST_NEGATIVE_LONG_FLOAT;
	SymbolStruct<?> LEAST_NEGATIVE_NORMALIZED_DOUBLE_FLOAT = Constant.LEAST_NEGATIVE_NORMALIZED_DOUBLE_FLOAT;
	SymbolStruct<?> LEAST_NEGATIVE_NORMALIZED_LONG_FLOAT = Constant.LEAST_NEGATIVE_NORMALIZED_LONG_FLOAT;
	SymbolStruct<?> LEAST_NEGATIVE_NORMALIZED_SHORT_FLOAT = Constant.LEAST_NEGATIVE_NORMALIZED_SHORT_FLOAT;
	SymbolStruct<?> LEAST_NEGATIVE_NORMALIZED_SINGLE_FLOAT = Constant.LEAST_NEGATIVE_NORMALIZED_SINGLE_FLOAT;
	SymbolStruct<?> LEAST_NEGATIVE_SHORT_FLOAT = Constant.LEAST_NEGATIVE_SHORT_FLOAT;
	SymbolStruct<?> LEAST_NEGATIVE_SINGLE_FLOAT = Constant.LEAST_NEGATIVE_SINGLE_FLOAT;
	SymbolStruct<?> LEAST_POSITIVE_DOUBLE_FLOAT = Constant.LEAST_POSITIVE_DOUBLE_FLOAT;
	SymbolStruct<?> LEAST_POSITIVE_LONG_FLOAT = Constant.LEAST_POSITIVE_LONG_FLOAT;
	SymbolStruct<?> LEAST_POSITIVE_NORMALIZED_DOUBLE_FLOAT = Constant.LEAST_POSITIVE_NORMALIZED_DOUBLE_FLOAT;
	SymbolStruct<?> LEAST_POSITIVE_NORMALIZED_LONG_FLOAT = Constant.LEAST_POSITIVE_NORMALIZED_LONG_FLOAT;
	SymbolStruct<?> LEAST_POSITIVE_NORMALIZED_SHORT_FLOAT = Constant.LEAST_POSITIVE_NORMALIZED_SHORT_FLOAT;
	SymbolStruct<?> LEAST_POSITIVE_NORMALIZED_SINGLE_FLOAT = Constant.LEAST_POSITIVE_NORMALIZED_SINGLE_FLOAT;
	SymbolStruct<?> LEAST_POSITIVE_SHORT_FLOAT = Constant.LEAST_POSITIVE_SHORT_FLOAT;
	SymbolStruct<?> LEAST_POSITIVE_SINGLE_FLOAT = Constant.LEAST_POSITIVE_SINGLE_FLOAT;
	SymbolStruct<?> LONG_FLOAT_EPSILON = Constant.LONG_FLOAT_EPSILON;
	SymbolStruct<?> LONG_FLOAT_NEGATIVE_EPSILON = Constant.LONG_FLOAT_NEGATIVE_EPSILON;
	SymbolStruct<?> MOST_NEGATIVE_DOUBLE_FLOAT = Constant.MOST_NEGATIVE_DOUBLE_FLOAT;
	SymbolStruct<?> MOST_NEGATIVE_FIXNUM = Constant.MOST_NEGATIVE_FIXNUM;
	SymbolStruct<?> MOST_NEGATIVE_LONG_FLOAT = Constant.MOST_NEGATIVE_LONG_FLOAT;
	SymbolStruct<?> MOST_NEGATIVE_SHORT_FLOAT = Constant.MOST_NEGATIVE_SHORT_FLOAT;
	SymbolStruct<?> MOST_NEGATIVE_SINGLE_FLOAT = Constant.MOST_NEGATIVE_SINGLE_FLOAT;
	SymbolStruct<?> MOST_POSITIVE_DOUBLE_FLOAT = Constant.MOST_POSITIVE_DOUBLE_FLOAT;
	SymbolStruct<?> MOST_POSITIVE_FIXNUM = Constant.MOST_POSITIVE_FIXNUM;
	SymbolStruct<?> MOST_POSITIVE_LONG_FLOAT = Constant.MOST_POSITIVE_LONG_FLOAT;
	SymbolStruct<?> MOST_POSITIVE_SHORT_FLOAT = Constant.MOST_POSITIVE_SHORT_FLOAT;
	SymbolStruct<?> MOST_POSITIVE_SINGLE_FLOAT = Constant.MOST_POSITIVE_SINGLE_FLOAT;
	SymbolStruct<?> MULTIPLE_VALUES_LIMIT = Constant.MULTIPLE_VALUES_LIMIT;
	SymbolStruct<?> NIL = Constant.NIL;
	SymbolStruct<?> PI = Constant.PI;
	SymbolStruct<?> SHORT_FLOAT_EPSILON = Constant.SHORT_FLOAT_EPSILON;
	SymbolStruct<?> SHORT_FLOAT_NEGATIVE_EPSILON = Constant.SHORT_FLOAT_NEGATIVE_EPSILON;
	SymbolStruct<?> SINGLE_FLOAT_EPSILON = Constant.SINGLE_FLOAT_EPSILON;
	SymbolStruct<?> SINGLE_FLOAT_NEGATIVE_EPSILON = Constant.SINGLE_FLOAT_NEGATIVE_EPSILON;
	SymbolStruct<?> T = Constant.T;
	...
	SymbolStruct<?> BREAK_ON_SIGNALS_VAR = Variable.BREAK_ON_SIGNALS;
	SymbolStruct<?> COMPILE_FILE_PATHNAME_VAR = Variable.COMPILE_FILE_PATHNAME;
	SymbolStruct<?> COMPILE_FILE_TRUENAME_VAR = Variable.COMPILE_FILE_TRUENAME;
	SymbolStruct<?> COMPILE_PRINT_VAR = Variable.COMPILE_PRINT;
	SymbolStruct<?> COMPILE_VERBOSE_VAR = Variable.COMPILE_VERBOSE;
	SymbolStruct<?> DEBUG_IO_VAR = Variable.DEBUG_IO;
	SymbolStruct<?> DEBUGGER_HOOK_VAR = Variable.DEBUGGER_HOOK;
	SymbolStruct<?> DEFAULT_PATHNAME_DEFAULTS_VAR = Variable.DEFAULT_PATHNAME_DEFAULTS;
	SymbolStruct<?> ERROR_OUTPUT_VAR = Variable.ERROR_OUTPUT;
	SymbolStruct<?> FEATURES_VAR = Variable.FEATURES;
	SymbolStruct<?> GENSYM_COUNTER_VAR = Variable.GENSYM_COUNTER;
	SymbolStruct<?> LOAD_PATHNAME_VAR = Variable.LOAD_PATHNAME;
	SymbolStruct<?> LOAD_PRINT_VAR = Variable.LOAD_PRINT;
	SymbolStruct<?> LOAD_TRUENAME_VAR = Variable.LOAD_TRUENAME;
	SymbolStruct<?> LOAD_VERBOSE_VAR = Variable.LOAD_VERBOSE;
	SymbolStruct<?> MACROEXPAND_HOOK_VAR = Variable.MACROEXPAND_HOOK;
	SymbolStruct<?> MODULES_VAR = Variable.MODULES;
	SymbolStruct<?> PACKAGE_VAR = Variable.PACKAGE;
	SymbolStruct<?> PRINT_ARRAY_VAR = Variable.PRINT_ARRAY;
	SymbolStruct<?> PRINT_BASE_VAR = Variable.PRINT_BASE;
	SymbolStruct<?> PRINT_CASE_VAR = Variable.PRINT_CASE;
	SymbolStruct<?> PRINT_CIRCLE_VAR = Variable.PRINT_CIRCLE;
	SymbolStruct<?> PRINT_ESCAPE_VAR = Variable.PRINT_ESCAPE;
	SymbolStruct<?> PRINT_GENSYM_VAR = Variable.PRINT_GENSYM;
	SymbolStruct<?> PRINT_LEVEL_VAR = Variable.PRINT_LEVEL;
	SymbolStruct<?> PRINT_LENGTH_VAR = Variable.PRINT_LENGTH;
	SymbolStruct<?> PRINT_LINES_VAR = Variable.PRINT_LINES;
	SymbolStruct<?> PRINT_MISER_WIDTH_VAR = Variable.PRINT_MISER_WIDTH;
	SymbolStruct<?> PRINT_PPRINT_DISPATCH_VAR = Variable.PRINT_PPRINT_DISPATCH;
	SymbolStruct<?> PRINT_PRETTY_VAR = Variable.PRINT_PRETTY;
	SymbolStruct<?> PRINT_RADIX_VAR = Variable.PRINT_RADIX;
	SymbolStruct<?> PRINT_READABLY_VAR = Variable.PRINT_READABLY;
	SymbolStruct<?> PRINT_RIGHT_MARGIN_VAR = Variable.PRINT_RIGHT_MARGIN;
	SymbolStruct<?> QUERY_IO_VAR = Variable.QUERY_IO;
	SymbolStruct<?> RANDOM_STATE_VAR = Variable.RANDOM_STATE;
	SymbolStruct<?> READ_BASE_VAR = Variable.READ_BASE;
	SymbolStruct<?> READ_DEFAULT_FLOAT_FORMAT_VAR = Variable.READ_DEFAULT_FLOAT_FORMAT;
	SymbolStruct<?> READ_EVAL_VAR = Variable.READ_EVAL;
	SymbolStruct<?> READ_SUPPRESS_VAR = Variable.READ_SUPPRESS;
	SymbolStruct<?> READTABLE_VAR = Variable.READTABLE;
	SymbolStruct<?> STANDARD_INPUT_VAR = Variable.STANDARD_INPUT;
	SymbolStruct<?> STANDARD_OUTPUT_VAR = Variable.STANDARD_OUTPUT;
	SymbolStruct<?> TERMINAL_IO_VAR = Variable.TERMINAL_IO;
	SymbolStruct<?> TRACE_OUTPUT_VAR = Variable.TRACE_OUTPUT;

	SymbolStruct<?> STAR = Variable.STAR;
	SymbolStruct<?> STAR_STAR = Variable.STAR_STAR;
	SymbolStruct<?> STAR_STAR_STAR = Variable.STAR_STAR_STAR;
	SymbolStruct<?> PLUS = Variable.PLUS;
	SymbolStruct<?> PLUS_PLUS = Variable.PLUS_PLUS;
	SymbolStruct<?> PLUS_PLUS_PLUS = Variable.PLUS_PLUS_PLUS;
	SymbolStruct<?> DASH = Variable.DASH;
	SymbolStruct<?> SLASH = Variable.SLASH;
	SymbolStruct<?> SLASH_SLASH = Variable.SLASH_SLASH;
	SymbolStruct<?> SLASH_SLASH_SLASH = Variable.SLASH_SLASH_SLASH;
