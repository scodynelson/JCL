...
public final class CharGTFunction extends AbstractCharacterEqualityFunction {
	...
	/**
	 * {@inheritDoc}
	 * Returns {@link CharacterStruct#isGreaterThan(CharacterStruct...)} as a method reference function.
	 *
	 * @return returns {@link CharacterStruct#isGreaterThan(CharacterStruct...)} as a method reference function
	 */
	@Override
