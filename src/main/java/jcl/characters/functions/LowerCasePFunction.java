...
@Component
public final class LowerCasePFunction extends FunctionStruct {
	...
	public SymbolStruct<?> getFunctionSymbol() {
		...
		final SymbolStruct<?> symbol = aPackage.intern("LOWER-CASE-P").getSymbol();
	...
	public LispStruct apply(final LispStruct... lispStructs) {
		...
		validator.validateTypes(lispStruct, "LOWER-CASE-P", "Character", CharacterType.INSTANCE);

		final CharacterStruct character = (CharacterStruct) lispStruct;
		final boolean lowerCase = character.isLowerCase();
		return BooleanStructs.toLispBoolean(lowerCase);
	}
}
