...
@Component
public final class UpperCasePFunction extends FunctionStruct {
	...
	public SymbolStruct<?> getFunctionSymbol() {
		...
		final SymbolStruct<?> symbol = aPackage.intern("UPPER-CASE-P").getSymbol();
	...
	public LispStruct apply(final LispStruct... lispStructs) {
		...
		validator.validateTypes(lispStruct, "UPPER-CASE-P", "Character", CharacterType.INSTANCE);

		final CharacterStruct character = (CharacterStruct) lispStruct;
		final boolean upperCase = character.isUpperCase();
		return BooleanStructs.toLispBoolean(upperCase);
	}
}
