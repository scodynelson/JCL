...
public class LabelsEnvironmentListStruct extends ListStruct {

	private final Environment environment;
	private final ListStruct listStruct;

	public LabelsEnvironmentListStruct(final Environment environment, final ListStruct listStruct) {
		super(null, null);
