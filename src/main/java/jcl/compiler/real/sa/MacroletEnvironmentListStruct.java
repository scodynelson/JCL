...
public class MacroletEnvironmentListStruct extends ListStruct {

	private final Environment environment;
	private final ListStruct listStruct;

	public MacroletEnvironmentListStruct(final Environment environment, final ListStruct listStruct) {
		super(null, null);
