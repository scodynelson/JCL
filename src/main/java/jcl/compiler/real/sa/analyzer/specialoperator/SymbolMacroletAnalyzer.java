...
@Component
public class SymbolMacroletAnalyzer extends MacroFunctionExpander implements SpecialOperatorAnalyzer {
	...
	@Override
	public SymbolMacroletStruct analyze(final ListStruct input, final AnalysisBuilder analysisBuilder) {
