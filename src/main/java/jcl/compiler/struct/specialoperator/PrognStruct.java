...
public class PrognStruct extends CompilerSpecialOperatorStruct {
	...
	/**
	 * {@inheritDoc} Generation method for {@code PrognStruct} objects. If the {@link PrognStruct#forms} {@link List} is
	 * empty, a {@link NILStruct} is generated. Otherwise, each form value is generated. When iterating through and
	 * generating each of the forms, each of the form generation results will be popped off the top of the Stack, except
	 * for the final generated form.
	 *
