...
public interface CharacterStruct extends LispStruct {
	 ...
	 */
	static BooleanStruct isEqualTo(final List<CharacterStruct> characters) {
		final CharacterStruct[] array = new CharacterStruct[characters.size()];
		characters.toArray(array);
		return isEqualTo(array);
	}
	 ...
	 * @return the '!=' comparison of the provided CharacterStructs
	 */
	static BooleanStruct isNotEqualTo(final List<CharacterStruct> characters) {
		final CharacterStruct[] array = new CharacterStruct[characters.size()];
		characters.toArray(array);
		return isNotEqualTo(array);
	}
	 ...
	 */
	static BooleanStruct isLessThan(final List<CharacterStruct> characters) {
		final CharacterStruct[] array = new CharacterStruct[characters.size()];
		characters.toArray(array);
		return isLessThan(array);
	}
	 ...
	 * @return the {@literal '>'} comparison of the provided CharacterStructs
	 */
	static BooleanStruct isGreaterThan(final List<CharacterStruct> characters) {
		final CharacterStruct[] array = new CharacterStruct[characters.size()];
		characters.toArray(array);
		return isGreaterThan(array);
	}
	 ...
	 * @return the {@literal '<='} comparison of the provided CharacterStructs
	 */
	static BooleanStruct isLessThanOrEqualTo(final List<CharacterStruct> characters) {
		final CharacterStruct[] array = new CharacterStruct[characters.size()];
		characters.toArray(array);
		return isLessThanOrEqualTo(array);
	}
	 ...
	 * @return the {@literal '>='} comparison of the provided CharacterStructs
	 */
	static BooleanStruct isGreaterThanOrEqualTo(final List<CharacterStruct> characters) {
		final CharacterStruct[] array = new CharacterStruct[characters.size()];
		characters.toArray(array);
		return isGreaterThanOrEqualTo(array);
	}
	 ...
	 * @return the '=' comparison of the provided CharacterStructs
	 */
	static BooleanStruct isEqualToIgnoreCase(final List<CharacterStruct> characters) {
		final CharacterStruct[] array = new CharacterStruct[characters.size()];
		characters.toArray(array);
		return isEqualToIgnoreCase(array);
	}
	 ...
	 * @return the '!=' comparison of the provided CharacterStructs
	 */
	static BooleanStruct isNotEqualToIgnoreCase(final List<CharacterStruct> characters) {
		final CharacterStruct[] array = new CharacterStruct[characters.size()];
		characters.toArray(array);
		return isNotEqualToIgnoreCase(array);
	}
	 ...
	 * @return the {@literal '<'} comparison of the provided CharacterStructs
	 */
	static BooleanStruct isLessThanIgnoreCase(final List<CharacterStruct> characters) {
		final CharacterStruct[] array = new CharacterStruct[characters.size()];
		characters.toArray(array);
		return isLessThanIgnoreCase(array);
	}
	 ...
	 * @return the {@literal '>'} comparison of the provided CharacterStructs
	 */
	static BooleanStruct isGreaterThanIgnoreCase(final List<CharacterStruct> characters) {
		final CharacterStruct[] array = new CharacterStruct[characters.size()];
		characters.toArray(array);
		return isGreaterThanIgnoreCase(array);
	}
	 ...
	 * @return the {@literal '<='} comparison of the provided CharacterStructs
	 */
	static BooleanStruct isLessThanOrEqualToIgnoreCase(final List<CharacterStruct> characters) {
		final CharacterStruct[] array = new CharacterStruct[characters.size()];
		characters.toArray(array);
		return isLessThanOrEqualToIgnoreCase(array);
	}
	 ...
	 * @return the {@literal '>='} comparison of the provided CharacterStructs
	 */
	static BooleanStruct isGreaterThanOrEqualToIgnoreCase(final List<CharacterStruct> characters) {
		final CharacterStruct[] array = new CharacterStruct[characters.size()];
		characters.toArray(array);
		return isGreaterThanOrEqualToIgnoreCase(array);
	}
