...
public interface NumberConstants {
	...
	ConstantStruct<FloatStruct> LEAST_POSITIVE_NORMALIZED_SHORT_FLOAT = new ConstantStruct<>("LEAST-POSITIVE-NORMALIZED-SHORT-FLOAT", GlobalPackageStruct.COMMON_LISP, FloatStruct.valueOf(Double.MIN_NORMAL));
	...
	ConstantStruct<FloatStruct> LEAST_NEGATIVE_NORMALIZED_SHORT_FLOAT = new ConstantStruct<>("LEAST-NEGATIVE-NORMALIZED-SHORT-FLOAT", GlobalPackageStruct.COMMON_LISP, FloatStruct.valueOf(-Double.MIN_NORMAL));
	ConstantStruct<FloatStruct> SHORT_FLOAT_EPSILON = new ConstantStruct<>("SHORT-FLOAT-EPSILON", GlobalPackageStruct.COMMON_LISP, FloatStruct.valueOf(1.1102230246251568E-16));
	ConstantStruct<FloatStruct> SHORT_FLOAT_NEGATIVE_EPSILON = new ConstantStruct<>("SHORT-FLOAT-NEGATIVE-EPSILON", GlobalPackageStruct.COMMON_LISP, FloatStruct.valueOf(5.551115123125784E-17));
	...
	ConstantStruct<FloatStruct> LEAST_POSITIVE_NORMALIZED_SINGLE_FLOAT = new ConstantStruct<>("LEAST-POSITIVE-NORMALIZED-SINGLE-FLOAT", GlobalPackageStruct.COMMON_LISP, FloatStruct.valueOf(Double.MIN_NORMAL));
	...
	ConstantStruct<FloatStruct> LEAST_NEGATIVE_NORMALIZED_SINGLE_FLOAT = new ConstantStruct<>("LEAST-NEGATIVE-NORMALIZED-SINGLE-FLOAT", GlobalPackageStruct.COMMON_LISP, FloatStruct.valueOf(-Double.MIN_NORMAL));
	ConstantStruct<FloatStruct> SINGLE_FLOAT_EPSILON = new ConstantStruct<>("SINGLE-FLOAT-EPSILON", GlobalPackageStruct.COMMON_LISP, FloatStruct.valueOf(1.1102230246251568E-16));
	ConstantStruct<FloatStruct> SINGLE_FLOAT_NEGATIVE_EPSILON = new ConstantStruct<>("SINGLE-FLOAT-NEGATIVE-EPSILON", GlobalPackageStruct.COMMON_LISP, FloatStruct.valueOf(5.551115123125784E-17));
