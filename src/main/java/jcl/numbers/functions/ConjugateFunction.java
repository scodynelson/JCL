...
@Component
public final class ConjugateFunction extends FunctionStruct {
	...
	private ConjugateFunction() {
		super("", getInitLambdaListBindings());
	}

	@PostConstruct
	private void init() {
		CONJUGATE.setFunction(this);
		GlobalPackageStruct.COMMON_LISP.export(CONJUGATE);
	}
