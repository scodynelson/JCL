...
@Component
public final class GreaterThanFunction extends FunctionStruct {
	...
	@PostConstruct
	private void init() {
		GREATER_THAN.setFunction(this);
		GlobalPackageStruct.COMMON_LISP.export(GREATER_THAN);
	}
	...
	public LispStruct apply(final LispStruct... lispStructs) {
		...
		return RealStruct.isGreaterThan(reals) ? TStruct.INSTANCE : NILStruct.INSTANCE;
	}
