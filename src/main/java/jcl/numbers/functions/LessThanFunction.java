...
@Component
public final class LessThanFunction extends FunctionStruct {
	...
	@PostConstruct
	private void init() {
		LESS_THAN.setFunction(this);
		GlobalPackageStruct.COMMON_LISP.export(LESS_THAN);
	}
	...
	public LispStruct apply(final LispStruct... lispStructs) {
		...
		return RealStruct.isLessThan(reals) ? TStruct.INSTANCE : NILStruct.INSTANCE;
	}
