...
public interface GlobalPackageStruct {
	...
	PackageStruct COMMON_LISP = new PackageStruct("COMMON-LISP", Collections.singletonList("CL"), COMPILER, BACKQUOTE);
	PackageStruct SYSTEM = new PackageStruct("SYSTEM", Collections.emptyList(), COMPILER, BACKQUOTE, COMMON_LISP);
