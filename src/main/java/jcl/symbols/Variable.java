...
import jcl.symbols.special.NonNegNilVariable;
import jcl.symbols.special.PrintBaseVariable;
import jcl.symbols.special.PrintCaseVariable;
...
public class Variable<T extends LispStruct> extends SymbolStruct<T> {
	...
	public static final Variable<IntegerStruct> PRINT_BASE = PrintBaseVariable.INSTANCE;
	...
	public static final Variable<IntegerStruct> PRINT_LEVEL = new NonNegNilVariable("*PRINT-LEVEL*");
	public static final Variable<IntegerStruct> PRINT_LENGTH = new NonNegNilVariable("*PRINT-LENGTH*");
	public static final Variable<IntegerStruct> PRINT_LINES = new NonNegNilVariable("*PRINT-LINES*");
	public static final Variable<IntegerStruct> PRINT_MISER_WIDTH = new NonNegNilVariable("*PRINT-MISER-WIDTH*");
	...
	public static final Variable<IntegerStruct> PRINT_RIGHT_MARGIN = new NonNegNilVariable("*PRINT-RIGHT-MARGIN*");
