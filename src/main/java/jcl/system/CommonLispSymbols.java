...
import jcl.compiler.ValuesFunction;
import jcl.compiler.functions.CompileFileFunction;
import jcl.compiler.functions.CompileFilePathnameFunction;
import jcl.compiler.functions.EvalFunction;
import jcl.compiler.functions.LoadFunction;
import jcl.compiler.functions.MacroExpand1Function;
...
import jcl.pathnames.functions.PathnameDeviceFunction;
import jcl.pathnames.functions.PathnameDirectoryFunction;
import jcl.pathnames.functions.PathnameFunction;
import jcl.pathnames.functions.PathnameHostFunction;
import jcl.pathnames.functions.PathnameNameFunction;
...
public interface CommonLispSymbols {
	...
	SymbolStruct PATHNAME = PathnameFunction.PATHNAME;
	SymbolStruct PATHNAME_DEVICE = PathnameDeviceFunction.PATHNAME_DEVICE;
	SymbolStruct PATHNAME_DIRECTORY = PathnameDirectoryFunction.PATHNAME_DIRECTORY;
	SymbolStruct PATHNAME_HOST = PathnameHostFunction.PATHNAME_HOST;
	SymbolStruct PATHNAME_MATCH_P = null;
	SymbolStruct PATHNAME_NAME = PathnameNameFunction.PATHNAME_NAME;
	SymbolStruct PATHNAME_TYPE = PathnameTypeFunction.PATHNAME_TYPE;
	SymbolStruct PATHNAME_VERSION = PathnameVersionFunction.PATHNAME_VERSION;
