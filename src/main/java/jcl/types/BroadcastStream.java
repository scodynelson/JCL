...
/**
 * A {@link BroadcastStream} is an output stream which which is a composite stream of zero or more other output streams,such
 * that any output sent to the {@link BroadcastStream} gets passed on as output to each of the associated output streams.
 * <p>
