...
/**
 * A {@link ConcatenatedStream} is an input stream which is a composite stream of zero or more other input streams, such
 * that the sequence of data which can be read from the {@link ConcatenatedStream} is the same as the concatenation of
 ...
 * of file on the associated input streams is always managed invisibly by the {@link ConcatenatedStream}---the only time
 * a client of a {@link ConcatenatedStream} sees an end of file is when an attempt is made to obtain data from the
